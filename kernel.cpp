...
gpu_bsw::warpReduceMax_with_index_reverse(short val, short& myIndex, short& myIndex2, const unsigned lengthSeqB)
{
...
__inline__ __device__ short
gpu_bsw::warpReduceMax_with_index(short val, short& myIndex, short& myIndex2, const unsigned lengthSeqB)
{
    constexpr int warpSize = 32;
    short myMax    = 0;
    short newInd   = 0;
...
gpu_bsw::findMaxFour(const short first, const short second, const short third, const short fourth)
{
    short maxScore = 0;
